    ...
    >
      <Stack maxW={{ md: 600, base: "auto" }}>
        ...
        <Text lineHeight={"taller"} maxW={{ md: 550, base: "auto" }}>
          ...
          community */}
          We&apos;re building a network of decentralized communities, called{" "}
          <b>Green spaces</b>, focused on longevity to help people live longer,
          better through community inclusive programs like challenges, events,
          weekly and one-on-one sessions with longevity focused nutritionists
          and incentivizing these nutritionists as a focal point, to improve
          health, productivity and make our members live happier lives with a
